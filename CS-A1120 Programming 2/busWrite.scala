...
object factory {
  ...
  def buildBusWriteUnit4(r0: Bus, r1: Bus, r2: Bus, r3: Bus,
    ...
    var wGate0 = writeEnable  && !writeTo(1)&& !writeTo(0)
    var wGate1 = writeEnable  && !writeTo(1)&&  writeTo(0)

    var wGate2 = writeEnable  && writeTo(1) && !writeTo(0)

    var wGate3 = writeEnable  && writeTo(1) &&  writeTo(0) 

    var s0 =  ((data && wGate0 ) | (r0 && !wGate0)) && !reset

    var s1 =  ((data && wGate1 ) | (r1 && !wGate1)) && !reset

    var s2 =  ((data && wGate2 ) | (r2 && !wGate2)) && !reset
    var s3 =  ((data && wGate3 ) | (r3 && !wGate3)) && !reset
